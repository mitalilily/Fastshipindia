...
const navItems = [
  ...
  ['Solutions', '/integrations/courier-partners'],
...
function Logo({ light = false }) {
  return <img className="brand-logo" src={light ? '/assets/fastshipindia-logo-light.svg' : '/assets/fastshipindia-logo.svg'} alt="Fsstshipindia" />
}
...
function Header() {
  ...
  return <header className="site-header">
    <div className="nav-shell">
      ...
      <div className="nav-actions"><Link className="text-link" to="/contact">Talk to us</Link><Link className="button button-dark button-small" to="/rate-calculator">Start shipping <ArrowRight size={15} /></Link></div>
    ...
    <section className="hero">
      ...
      <div className="shell hero-layout">
        <div className="hero-copy reveal-up">
          ...
          <p>Fsstshipindia brings routing, rates, visibility and real human support into one calm command centre for modern Indian businesses.</p>
        ...
        <div className="hero-visual reveal-float"><div className="route-beacon beacon-a" /><div className="route-beacon beacon-b" /><div className="route-beacon beacon-c" /><span className="route-dash dash-a" /><span className="route-dash dash-b" /><img src="/assets/fastshipindia-hero.png" alt="A blue parcel travelling through a network of glowing delivery routes" /><div className="hero-sticker"><span className="sticker-dot" /><div><strong>Route found</strong><small>Ahmedabad → Bengaluru</small></div><Check size={16} /></div></div>
      </div>
