...
export const DEFAULT_B2B_CHARGES_FORM = Object.freeze({
  awbCharges: '0',
  cftFactor: '5',
  ...
  freeStorageDays: '5',
  demurragePerAwbDay: '0',
  demurragePerKgDay: '0',
  demurrageMethod: 'whichever_is_higher',
  publicHolidayPickupCharge: '0',
  fuelSurchargePercentage: '0',
  greenTax: '100',
  greenTaxPerKg: '0.5',
  greenTaxMethod: 'whichever_is_higher',
  fmChargePerAwb: '0',
  fmChargePerKg: '100',
  fmChargeMethod: 'whichever_is_higher',
  toPayFixedAmount: '100',
  toPayPercentage: '0',
  toPayMethod: 'whichever_is_higher',
  odaCharges: '0',
  odaPerKgCharge: '0',
  odaMethod: 'whichever_is_higher',
  csdDeliveryCharge: '0',
  timeSpecificPerKg: '0',
  timeSpecificPerAwb: '500',
  timeSpecificMethod: 'whichever_is_higher',
  mallDeliveryPerKg: '0',
  mallDeliveryPerAwb: '500',
  mallDeliveryMethod: 'whichever_is_higher',
  deliveryReattemptPerKg: '0',
  deliveryReattemptPerAwb: '500',
  deliveryReattemptMethod: 'whichever_is_higher',
  handlingSinglePiece: '0',
  handlingBelow100Kg: '0',
  handling100To200Kg: '0',
  handlingAbove200Kg: '0',
  insuranceCharge: '0',
  codFixedAmount: '50',
  codPercentage: '1',
...
export const useB2BChargesForm = (charges) => {
  const [formData, setFormData] = useState(() => ({ ...DEFAULT_B2B_CHARGES_FORM }))
  ...
  useEffect(() => {
    if (charges) {
      ...
      const baseFormData = {
        ...
        greenTaxPerKg: formatValue(charges.green_tax_per_kg),
        greenTaxMethod: charges.green_tax_method || 'whichever_is_higher',
        fmChargePerAwb: formatValue(charges.fm_charge_per_awb),
        fmChargePerKg: formatValue(charges.fm_charge_per_kg),
        fmChargeMethod: charges.fm_charge_method || 'whichever_is_higher',
        toPayFixedAmount: formatValue(charges.to_pay_fixed_amount),
        toPayPercentage: formatValue(charges.to_pay_percentage),
        toPayMethod: charges.to_pay_method || 'whichever_is_higher',
      ...
      setFormData({ ...DEFAULT_B2B_CHARGES_FORM })
    }
  }, [charges])
