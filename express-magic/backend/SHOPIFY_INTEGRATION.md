...
```text
https://api.fastship.in/api/integrations/shopify/oauth/install
```
...
SHOPIFY_OAUTH_SUCCESS_URL=https://client.fastship.in/channels/connected
...
```text
https://api.fastship.in/api/webhooks/shopify/order-created
```
...
```bash
cd /srv/fastship/current/backend
