...
ALTER TABLE shiplifi_b2b_additional_charges
  ...
  ADD COLUMN IF NOT EXISTS fm_charge_per_kg NUMERIC(12, 4) NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS fm_charge_method varchar(30) NOT NULL DEFAULT 'whichever_is_higher',
  ADD COLUMN IF NOT EXISTS to_pay_fixed_amount NUMERIC(12, 2) NOT NULL DEFAULT 0,
  ...
  ADD COLUMN IF NOT EXISTS green_tax_per_kg NUMERIC(12, 4) NOT NULL DEFAULT 0,
