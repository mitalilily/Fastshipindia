...
Warehouse Creation, Shipment Creation, MPS Manifestation, Shipment
Updation/Edit, Shipment Cancellation, and Ewaybill Update are state-changing
and skipped by default; set `allowMutations=true` only when the mutation is
intended. Local Newman verification:
