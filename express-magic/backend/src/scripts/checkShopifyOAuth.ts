...
const applyMockEnv = () => {
  process.env.API_URL = 'https://api.fastship.in'
  ...
  process.env.SHOPIFY_OAUTH_SUCCESS_URL = 'https://client.fastship.in/channels/connected'
...
const main = async () => {
  ...
  const shop = normalizeShopifyDomain(options.shop || 'fastship-oauth-smoke.myshopify.com')
