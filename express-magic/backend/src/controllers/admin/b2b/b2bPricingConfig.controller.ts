...
export const upsertAdditionalChargesController = async (req: Request, res: Response) => {
  try {
    const charges = await upsertAdditionalCharges({
      ...
      greenTaxPerKg: req.body.greenTaxPerKg ?? req.body.green_tax_per_kg,
      greenTaxMethod: req.body.greenTaxMethod ?? req.body.green_tax_method,
      fmChargePerAwb: req.body.fmChargePerAwb ?? req.body.fm_charge_per_awb,
      fmChargePerKg: req.body.fmChargePerKg ?? req.body.fm_charge_per_kg,
      fmChargeMethod: req.body.fmChargeMethod ?? req.body.fm_charge_method,
      toPayFixedAmount: req.body.toPayFixedAmount ?? req.body.to_pay_fixed_amount,
      toPayPercentage: req.body.toPayPercentage ?? req.body.to_pay_percentage,
      toPayMethod: req.body.toPayMethod ?? req.body.to_pay_method,
