...
const businessTypes: BusinessType[] = [
  {
    ...
    description: 'You sell products in bulk to shops, retailers, or other companies.',
  },
  {
    label: 'I sell on online marketplaces',
    value: 'b2c',
    imageSrc: '/images/marketplace.webp',
    description: 'You sell your products on sites like Amazon, Flipkart, or Meesho.',
  },
  {
    label: 'I sell on my website or social media',
    value: 'd2c',
    imageSrc: '/images/website-illustration.webp',
    description: 'You sell directly to customers through your own website/ social media or shopify/woocommerce.',
  },
]

export default function BusinessTypeSelector({ selected, onChange, error }: BusinessTypeSelectorProps) {
