...
> = {
  individual: {
    panCardUrl: false,
    aadhaarFrontUrl: false,
    aadhaarBackUrl: false,
...
export const courierLogos: Record<string, string> = {
  ...
  'Blue Dart': '/logo/integrations/bluedart.png',
  bluedart: '/logo/integrations/bluedart.png',
  Movin: '/logo/integrations/default-courier.png',
  movin: '/logo/integrations/default-courier.png',
  'DP World': '/logo/integrations/default-courier.png',
  dpworld: '/logo/integrations/default-courier.png',
  Rivigo: '/logo/integrations/default-courier.png',
  rivigo: '/logo/integrations/default-courier.png',
  'TCI Express': '/logo/integrations/default-courier.png',
  tci: '/logo/integrations/default-courier.png',
  Gati: '/logo/integrations/default-courier.png',
  gati: '/logo/integrations/default-courier.png',
