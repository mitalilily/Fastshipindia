...
# VPS configuration
VPS_TARGET_PATH="${VPS_TARGET_PATH:-/srv/fastship/current/courier-cart-client/dist}"
...
export VITE_API_URL="${VITE_API_URL:-https://api.fastship.in/api}"
export VITE_APP_SOCKET_URL="${VITE_APP_SOCKET_URL:-https://api.fastship.in}"
