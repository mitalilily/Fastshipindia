            ...
            <Reveal delay={0.04}>
              <div className="max-w-2xl">
                ...
                <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
                  FastShip connects courier operations, pricing visibility, shipment tracking, and delivery follow-up into one cleaner logistics experience from booking to doorstep.
                </p>
